...
class PaymentProvider(models.Model):
    ...
    paypal_email_account = fields.Char(
        string="Email",
        help="The public business email solely used to identify the account with OnePay",
    ...
    def _onepay_get_api_url(self):
        ...
        if self.state == 'enabled':
            ...
            return 'https://mtf.onepay.vn/paygate/vpcpay.op'
